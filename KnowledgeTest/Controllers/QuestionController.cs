...
namespace KnowledgeTest.Controllers
{
    public class QuestionController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,Description,Type,TestId")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,Description,Type,TestId")] Question question)
        {
            if (ModelState.IsValid)
            {
